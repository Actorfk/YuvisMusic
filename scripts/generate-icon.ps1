...
$backgroundStart = [System.Drawing.Color]::FromArgb(255, 255, 249, 244)
$backgroundEnd = [System.Drawing.Color]::FromArgb(255, 225, 151, 184)
...
$depthBrush = New-Object System.Drawing.SolidBrush ([System.Drawing.Color]::FromArgb(38, 115, 55, 128))
...
$redBarShadow = New-RoundedPath -X 148 -Y 96 -Width 25 -Height 98 -Radius 12.5
$shadowBrush = New-Object System.Drawing.SolidBrush ([System.Drawing.Color]::FromArgb(42, 72, 23, 48))
$graphics.FillPath($shadowBrush, $whiteBarShadow)
$graphics.FillPath($shadowBrush, $redBarShadow)
$whiteBrush = New-Object System.Drawing.SolidBrush ([System.Drawing.Color]::White)
$redBrush = New-Object System.Drawing.SolidBrush ([System.Drawing.Color]::FromArgb(255, 190, 24, 68))
$graphics.FillPath($whiteBrush, $whiteBar)
$graphics.FillPath($redBrush, $redBar)

$accentBrush = New-Object System.Drawing.SolidBrush ([System.Drawing.Color]::FromArgb(255, 190, 24, 68))
