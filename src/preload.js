...
contextBridge.exposeInMainWorld('desktop', {
  ...
  setKeyboardShortcuts: (shortcuts) => ipcRenderer.invoke('shortcuts:set', shortcuts),
  onKeyboardShortcut: (callback) => ipcRenderer.on('shortcuts:trigger', (_event, action) => callback(action)),
  onKeyboardShortcutStatus: (callback) => ipcRenderer.on('shortcuts:status', (_event, status) => callback(status)),
